...
OUT_DIR="results_seeds_brightness_s5"
EXTRA_ARGS=()
...
for seed in $SEEDS; do
    ...
    echo "=== seed=${seed} → ${out} ==="
    python eval_cifar_classification.py --seed "$seed" --mlp --activation relu --te_dir data/CIFAR10-C/latent/brightness_s5 "${EXTRA_ARGS[@]}" | tee "$out"
done
